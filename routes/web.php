...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('whatsapp-accounts/{id}/reconnect', [\App\Http\Controllers\Admin\WhatsAppAccountController::class, 'reconnect'])->name('whatsapp_accounts.reconnect');
    Route::get('whatsapp-accounts/{id}/reconnect-status', [\App\Http\Controllers\Admin\WhatsAppAccountController::class, 'reconnectStatus'])->name('whatsapp_accounts.reconnect_status');
