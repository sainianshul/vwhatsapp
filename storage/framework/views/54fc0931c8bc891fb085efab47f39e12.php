<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const pages = [
            ...
            // Users
            { name: 'All Users', route: '<?php echo e(route('users.index')); ?>', icon: 'ki-outline ki-people', color: 'primary' },
            { name: 'Add User', route: '<?php echo e(route('users.create')); ?>', icon: 'ki-outline ki-user-square', color: 'success' },

            // WhatsApp Accounts
            { name: 'All Accounts', route: '<?php echo e(route('whatsapp_accounts.index')); ?>', icon: 'ki-outline ki-whatsapp', color: 'success' },
            { name: 'Trash Accounts', route: '<?php echo e(route('whatsapp_accounts.trash')); ?>', icon: 'ki-outline ki-trash', color: 'danger' },

            // Messages
            { name: 'Send Message', route: '<?php echo e(route('whatsapp_messages.create')); ?>', icon: 'ki-outline ki-send', color: 'primary' },
            { name: 'Message Logs', route: '<?php echo e(route('whatsapp_messages.index')); ?>', icon: 'ki-outline ki-document', color: 'info' },

            // Campaigns & Media
            { name: 'Bulk Campaigns', route: '<?php echo e(route('admin.bulk_campaigns.index')); ?>', icon: 'ki-outline ki-rocket', color: 'warning' },
            { name: 'Media Library', route: '<?php echo e(route('admin.media_library.index')); ?>', icon: 'ki-outline ki-folder', color: 'info' },

            // Support
            { name: 'Help & Support', route: '<?php echo e(route('tickets.index')); ?>', icon: 'ki-outline ki-questionnaire-tablet', color: 'primary' },
            { name: 'Create Ticket', route: '<?php echo e(route('tickets.create')); ?>', icon: 'ki-outline ki-plus-square', color: 'success' },

            // System
            { name: 'Login History', route: '<?php echo e(route('login_history.index')); ?>', icon: 'ki-outline ki-security-user', color: 'secondary' },
            { name: 'Developer Settings', route: '<?php echo e(route('admin.developer_settings.index')); ?>', icon: 'ki-outline ki-code', color: 'danger' }
        ];
