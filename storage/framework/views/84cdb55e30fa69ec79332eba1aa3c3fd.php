...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed">
    <!-- Navbar -->
    <?php echo $__env->make('layouts.partials._front_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="py-15 bg-white text-center border-top border-gray-200">
        <div class="container">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn btn-success btn-lg px-10 py-4 fw-bolder shadow-sm">Start Your Journey Today</a>
        </div>
    </div>

    <!-- Enhanced Footer -->
    <?php echo $__env->make('layouts.partials._front_footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
