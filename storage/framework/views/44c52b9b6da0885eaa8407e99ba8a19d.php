        ...
        <div class="card-header border-0 pt-5 pb-3">
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="position-relative">
                            ...
                            <select id="filter-account" class="form-select form-select-transparent border border-gray-800 text-gray-900 form-select-sm fw-semibold ps-11 shadow-sm" data-control="select2" data-placeholder="All Accounts" data-allow-clear="true" data-hide-search="true">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($acc->id); ?>"><?php echo e($acc->phone_number); ?></option>
                    ...
                    <a href="<?php echo e(route('whatsapp_messages.create')); ?>" class="btn btn-sm btn-primary fw-semibold btn-flex btn-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/whatsapp_messages/index.blade.php ENDPATH**/ ?>