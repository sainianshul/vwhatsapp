<?php $__env->startSection('title', 'Link Social Account'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Link Social Account','description' => 'Discover and attach a digital footprint to '.e($subject->name).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Link Social Account','description' => 'Discover and attach a digital footprint to '.e($subject->name).'']); ?>
            ...
            <div class="card card-bordered shadow-sm border-gray-300 mb-5 mb-xl-10">
                <div class="card-body p-9 text-center">
                    ...
                    <form id="search-form" class="position-relative w-100 max-w-600px mx-auto mb-5" onsubmit="event.preventDefault(); performSearch();">
                        ...
                        <input type="text" id="search-query" class="form-control form-control-solid form-control-lg ps-12 border-primary" placeholder="e.g. <?php echo e($subject->name); ?> or https://facebook.com/..." required minlength="2">
...
<script>
    const subjectId = <?php echo e($subject->id); ?>;
    ...
    function performSearch() {
        ...
        $.ajax({
            url: "<?php echo e(route('social-accounts.search')); ?>",
            type: "POST",
            data: {
    ...
    function linkAccount(btn) {
        ...
        $.ajax({
            url: "<?php echo e(route('social-accounts.store')); ?>",
            type: "POST",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/subjects/add-account.blade.php ENDPATH**/ ?>