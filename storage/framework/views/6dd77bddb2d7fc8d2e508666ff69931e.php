    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body py-4">
            ...
            <div id="users-table-wrapper" class="table-responsive">
                <table id="users-table" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-3 w-100">
                    <thead>
            ...
            <?php echo $__env->make('layouts.partials._table-skeleton', ['id' => 'users-skeleton'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('layouts.partials._table-empty', ['id' => 'users-empty'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        $(function () {
            var table = $('#users-table').DataTable({
                ...
                processing: false,
                ajax: {
                    url: '<?php echo e(route('users.trash')); ?>'
                },
                columns: [
                ...
                initComplete: function () {
                    $('#users-skeleton').fadeOut(200, function () { $(this).remove(); });
                },
            ...
            $(document).on('click', '.btn-restore', function () {
                ...
                Swal.fire({
                    title: 'Restore User?',
                    text: 'This user will be active again.',
                    icon: 'question',
                    ...
                    $.post('/admin/users/' + id + '/restore', { _token: '<?php echo e(csrf_token()); ?>' })
                        .done(function () { table.ajax.reload(null, false); toastr.success('User restored.'); })
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/users/trash.blade.php ENDPATH**/ ?>