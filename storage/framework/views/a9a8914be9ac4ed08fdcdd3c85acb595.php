            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                <div class="alert alert-success d-flex align-items-center p-5 mb-10 shadow-sm border-success">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-success"><?php echo e(session('success')); ?></h4>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('new_token')): ?>
                <div class="alert alert-warning bg-light-warning border border-warning d-flex align-items-center p-5 mb-10 shadow-sm">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="mt-3">
                            <code class="fs-4 fw-bold p-3 bg-white text-dark rounded border border-dark d-inline-block shadow-sm"><?php echo e(session('new_token')); ?></code>
                        </div>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-xl-12">
                    <div class="card shadow-sm h-xl-100 border">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <?php echo $__env->make('layouts.partials._table-skeleton', ['id' => 'tokens-skeleton'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="modal fade" id="kt_modal_new_key" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-500px">
        <div class="modal-content shadow-lg">
            <form action="<?php echo e(route('admin.developer_settings.generate')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
        $(function () {
            let table = $('#tokens-table').DataTable({
                ...
                processing: false,
                ajax: {
                    url: '<?php echo e(route('admin.developer_settings.index')); ?>',
                },
                columns: [
                    { data: 'name', name: 'name' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/developer_settings/index.blade.php ENDPATH**/ ?>