<div class="card card-bordered shadow-sm border-gray-300">
    ...
    <div class="card-body py-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allPosts->isEmpty()): ?>
        ...
        <?php else: ?>
            <form id="bulkEngageForm" action="<?php echo e(route('posts.bulk-engage')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row g-5 g-xl-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card card-bordered h-100 shadow-sm position-relative post-card">
                                ...
                                <div class="position-absolute top-0 start-0 mt-4 ms-4 z-index-1">
                                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                                        <input class="form-check-input post-checkbox" type="checkbox" name="post_ids[]" value="<?php echo e($post->id); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="card-body d-flex flex-column p-5 pt-12">
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="symbol symbol-35px me-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->socialAccount->profile_pic_url): ?>
                                                <img src="<?php echo e($post->socialAccount->profile_pic_url); ?>" alt="">
                                            <?php else: ?>
                                                <span class="symbol-label bg-light-<?php echo e($post->socialAccount->platform_color); ?> text-<?php echo e($post->socialAccount->platform_color); ?>">
                                                    <i class="<?php echo e($post->socialAccount->platform_icon); ?>"></i>
                                                </span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a href="<?php echo e($post->socialAccount->account_url); ?>" target="_blank" class="text-gray-900 text-hover-primary fw-bold fs-6">
                                                <?php echo e($post->socialAccount->account_name); ?>

                                            </a>
                                            <span class="text-muted fw-semibold fs-8"><?php echo e($post->posted_at ? $post->posted_at->format('d M Y, H:i') : 'Unknown date'); ?></span>
                                        </div>
                                        <div>
                                            <span class="badge badge-light-<?php echo e($post->type_color); ?>"><?php echo e(ucfirst($post->post_type)); ?></span>
                                        </div>
                                    </div>

                                    <!-- Post Content -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->media_url): ?>
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover min-h-200px rounded mb-4 border border-gray-200" 
                                             style="background-image: url('<?php echo e($post->media_url); ?>')">
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="text-gray-800 fw-medium fs-6 mb-5 flex-grow-1" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden;">
                                        <?php echo e($post->content ?: 'No text content available.'); ?>
                                    ...
                                    <div class="d-flex flex-stack border-top border-gray-200 pt-4 mt-auto">
                                        <div class="d-flex align-items-center gap-4">
                                            <span class="d-flex align-items-center text-gray-600 fs-7 fw-semibold">
                                                <i class="ki-outline ki-heart fs-5 me-1 text-danger"></i> <?php echo e(number_format($post->likes_count)); ?>

                                            </span>
                                            <span class="d-flex align-items-center text-gray-600 fs-7 fw-semibold">
                                                <i class="ki-outline ki-message-text fs-5 me-1 text-primary"></i> <?php echo e(number_format($post->comments_count)); ?>

                                            </span>
                                            <span class="d-flex align-items-center text-gray-600 fs-7 fw-semibold">
                                                <i class="ki-outline ki-send fs-5 me-1 text-info"></i> <?php echo e(number_format($post->shares_count)); ?>

                                            </span>
                                        </div>
                                        <div>
                                            <button type="button" class="btn btn-sm btn-light-primary px-3 py-2 btn-quick-reply" data-id="<?php echo e($post->id); ?>">
                                        ...
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <select name="automation_template_id" id="modalTemplateSelect" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a Template">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($template->id); ?>"><?php echo e($template->name); ?> (<?php echo e($template->platform); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </select>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/resources/views/subjects/tabs/posts.blade.php ENDPATH**/ ?>