...
<script src="<?php echo e(asset('js/admin-sidebar.js')); ?>?v=8"></script>
<!--end::Custom Sidebar-->


<?php echo $__env->yieldPushContent('datatables_js'); ?>
...
$(document).ready(function() {
    ...
    $('#mark-all-read-btn').on('click', function(e) {
        ...
        $.post('/notifications/mark-all-as-read', {
            _token: '<?php echo e(csrf_token()); ?>' // Needs token, but we are in a JS block. Might fail if csrf not available. Let's add it.
        }, function(response) {
            if (response.success) {
                fetchNotifications();
            }
...
<!--end::Javascript--><?php /**PATH /var/www/resources/views/layouts/partials/_scripts.blade.php ENDPATH**/ ?>