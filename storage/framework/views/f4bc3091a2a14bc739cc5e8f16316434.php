        ...
        <div class="row text-center text-md-start">
            <div class="col-md-6 mb-10 mb-md-0">
                <div class="d-flex align-items-center justify-content-center justify-content-md-start mb-5">
                    <img alt="Logo" src="<?php echo e(asset('icon.png')); ?>" class="h-40px me-3" />
            ...
            <div class="col-md-6 mb-10 mb-md-0 d-flex flex-column align-items-center align-items-md-end">
                ...
                <ul class="list-unstyled text-center text-md-end">
                    <li class="mb-3"><a href="<?php echo e(route('home')); ?>" class="text-gray-600 text-hover-success text-decoration-none">Home</a></li>
                    <li class="mb-3"><a href="<?php echo e(route('home')); ?>#features" class="text-gray-600 text-hover-success text-decoration-none">Features</a></li>
                    <li class="mb-3"><a href="<?php echo e(route('login')); ?>" class="text-gray-600 text-hover-success text-decoration-none">Log In</a></li>
                </ul>
            </div>
        </div>
...
<?php /**PATH /var/www/resources/views/layouts/partials/_front_footer.blade.php ENDPATH**/ ?>