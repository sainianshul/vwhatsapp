        ...
        <div class="card-header border-0 pt-5 pb-3">
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo e(route('subjects.create')); ?>" class="btn btn-sm btn-primary fw-semibold btn-flex btn-center">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-skeleton','data' => ['columns' => 5,'rows' => 5]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['columns' => 5,'rows' => 5]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        var dt = $('#subjects-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('subjects.index')); ?>",
                data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/subjects/index.blade.php ENDPATH**/ ?>