    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form action="<?php echo e(route('automation-templates.update', ['automation_template' => $template->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body py-4">
                            <div class="row g-9 mb-8">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="e.g. Angry Citizen Campaign" value="<?php echo e(old('name', $template->name)); ?>" required>
                                </div>
                                <div class="col-md-6 fv-row">
                                    ...
                                    <select class="form-select" data-control="select2" data-hide-search="true" name="platform" required>
                                        <option value="facebook" <?php echo e(old('platform', $template->platform) == 'facebook' ? 'selected' : ''); ?>>Facebook</option>
                                        <option value="instagram" <?php echo e(old('platform', $template->platform) == 'instagram' ? 'selected' : ''); ?>>Instagram</option>
                                        <option value="twitter" <?php echo e(old('platform', $template->platform) == 'twitter' ? 'selected' : ''); ?>>Twitter</option>
                                        <option value="youtube" <?php echo e(old('platform', $template->platform) == 'youtube' ? 'selected' : ''); ?>>YouTube</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row g-9 mb-8">
                                <div class="col-md-6 fv-row">
                                    ...
                                    <select class="form-select" data-control="select2" data-hide-search="true" name="engine_type" id="engine_type_select" required>
                                        <option value="ai" <?php echo e(old('engine_type', $template->engine_type) == 'ai' ? 'selected' : ''); ?>>AI Generator (Smart)</option>
                                        <option value="bank" <?php echo e(old('engine_type', $template->engine_type) == 'bank' ? 'selected' : ''); ?>>Comment Bank (Manual)</option>
                                    </select>
                                </div>
                                <div class="col-md-6 fv-row" id="tone_container">
                                    ...
                                    <select class="form-select" data-control="select2" data-hide-search="true" name="ai_tone" required>
                                        <option value="positive" <?php echo e(old('ai_tone', $template->ai_tone) == 'positive' ? 'selected' : ''); ?>>Positive & Supportive</option>
                                        <option value="neutral" <?php echo e(old('ai_tone', $template->ai_tone) == 'neutral' ? 'selected' : ''); ?>>Neutral & Informative</option>
                                        <option value="negative" <?php echo e(old('ai_tone', $template->ai_tone) == 'negative' ? 'selected' : ''); ?>>Negative & Angry</option>
                                        <option value="custom" <?php echo e(old('ai_tone', $template->ai_tone) == 'custom' ? 'selected' : ''); ?>>Custom Persona</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row g-9 mb-8" id="ai_prompt_container">
                                <div class="col-12 fv-row">
                                    ...
                                    <textarea class="form-control" name="ai_prompt" rows="3" placeholder="Example: Act as a local citizen complaining about traffic. Use local slang."><?php echo e(old('ai_prompt', $template->ai_prompt)); ?></textarea>
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row g-9 mb-8 mt-2">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control" name="keywords_include" placeholder="e.g. traffic, pothole, mayor" value="<?php echo e(old('keywords_include', $template->keywords_include)); ?>">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control" name="keywords_exclude" placeholder="e.g. rip, sad, death" value="<?php echo e(old('keywords_exclude', $template->keywords_exclude)); ?>">
                                    ...
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="number" class="form-control" name="min_likes_required" value="<?php echo e(old('min_likes_required', $template->min_likes_required ?? 0)); ?>" min="0">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input type="number" class="form-control me-2" name="min_delay_mins" value="<?php echo e(old('min_delay_mins', $template->min_delay_mins ?? 5)); ?>" min="1" max="120" placeholder="Min">
                                                <span class="text-muted mx-2">to</span>
                                                <input type="number" class="form-control ms-2" name="max_delay_mins" value="<?php echo e(old('max_delay_mins', $template->max_delay_mins ?? 15)); ?>" min="1" max="240" placeholder="Max">
                                            </div>
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="number" class="form-control" name="max_daily_comments" value="<?php echo e(old('max_daily_comments', $template->max_daily_comments ?? 20)); ?>" min="1" max="500">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/automation/templates/edit.blade.php ENDPATH**/ ?>