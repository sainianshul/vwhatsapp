    ...
    <div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="d-flex align-items-center text-decoration-none">
                <img src="<?php echo e(asset('icon.png')); ?>" alt="Logo" class="h-25px me-2" />
        ...
        <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-1 ms-md-3">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0 m-0 w-350px border-0 shadow-sm rounded">
                    <!-- Header -->
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo e(asset('assets/media/misc/menu-header-bg.jpg')); ?>'); background-color: #1e1e2d; padding: 1.5rem 1.5rem 1rem;">
...
<?php echo $__env->make('layouts.partials._quick-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/layouts/partials/_navbar.blade.php ENDPATH**/ ?>