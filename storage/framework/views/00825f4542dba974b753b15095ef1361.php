...
<?php endif; ?>
    ...
    <div class="row g-5 g-xl-10 mb-8 mb-xl-10">
        ...
        <div class="col-sm-6 col-xl-3">
            ...
            ?>
            <div class="card bg-light-<?php echo e($statusColor); ?> border border-<?php echo e($statusColor); ?> border-dashed shadow-sm hover-elevate-up">
                <div class="card-body d-flex align-items-center p-6">
                    <div class="symbol symbol-50px me-4">
                        <span class="symbol-label bg-<?php echo e($statusColor); ?> shadow-sm">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.bulk_campaigns.export', ['bulkCampaign' => $bulkCampaign->id, 'status' => 'all'])); ?>"><i class="ki-outline ki-document text-primary me-2"></i> All Messages</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.bulk_campaigns.export', ['bulkCampaign' => $bulkCampaign->id, 'status' => 'sent'])); ?>"><i class="ki-outline ki-check-circle text-success me-2"></i> Sent Only</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.bulk_campaigns.export', ['bulkCampaign' => $bulkCampaign->id, 'status' => 'failed'])); ?>"><i class="ki-outline ki-cross-circle text-danger me-2"></i> Failed Only</a></li>
                        </ul>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.comments','data' => ['type' => 'App\Models\BulkCampaign','modelId' => $bulkCampaign->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'App\Models\BulkCampaign','model-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bulkCampaign->id)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        $(function () {
            let table = $('#report-table').DataTable({
                ...
                processing: false,
                ajax: {
                    url: '<?php echo e(route('admin.bulk_campaigns.show', $bulkCampaign->id)); ?>',
                    data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/bulk_campaigns/show.blade.php ENDPATH**/ ?>