<?php $__env->startSection('title', 'Trashed WhatsApp Accounts'); ?>
    ...
    <script>
        $(function () {
            ...
            let table = $('#accounts-table').DataTable({
                ...
                ajax: {
                    url: '<?php echo e(route('whatsapp_accounts.trash')); ?>',
                },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/whatsapp_accounts/trash.blade.php ENDPATH**/ ?>